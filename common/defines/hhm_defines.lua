...
NDefines.NNavy.NAVAL_COMBAT_AIR_LOW_AA_TARGET_SCORE = 0.01 -- vanilla 5                           -- how much score factor from low AA guns (scales between 0->this number)
NDefines.NNavy.ANTI_AIR_TARGETING = 0.9 --vanilla value
...
NDefines.NMilitary.LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.04   -- 0.032
NDefines.NMilitary.LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.036   -- 0.032
...
NDefines.NIndustrialOrganisation.DESIGN_TEAM_RESEARCH_BONUS = 0.08							-- Research bonus for applying a Design Team that matches the technology
